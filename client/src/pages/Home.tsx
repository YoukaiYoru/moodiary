    ...
    return (
        <div className=" relative h-screen w-full flex justify-center items-center overflow-hidden">
            ...
            <div className="relative z-10 w-[40%] flex flex-col items-center rounded-4xl shadow-2xl p-6 border-2 border-[hsl(204,18%,80%)]
                ...
                <SignInButton
                    class= "bg-[hsl(83,12%,45%)] dark:bg-[#ffffff] dark:text-[#292933] font-dosis w-[70%] h-[3rem] flex justify-center items-center text-white text-2xl px-4 py-3 mt-12 mb-1.5 rounded-2xl transform transition hover:scale-110 duration-200 cursor-pointer"
                    mode="modal"
