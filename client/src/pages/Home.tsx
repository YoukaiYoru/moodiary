    ...
    <>
      {/* <div className="relative h-screen w-full flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center flex-grow">
          <div className="w-[40%] flex flex-col items-center rounded-4xl shadow-2xl p-6 border-2 border-[hsl(204,18%,80%)]
                        bg-gradient-to-b from-[#F8F2EF] to-[#D3DADC]
                        dark:from-[#1F1F1F] dark:to-[#2A2A2A]">
            <h1 className="font-playwrite text-6xl text-[#94461C] dark:text-white pt-8 pb-10">Moodiary</h1>
            <p className="font-dosis leading-relaxed text-lg text-center px-4 text-[#000000] dark:text-[#CCCCCC]">
      ...
      <div className="relative h-screen w-full flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center flex-grow px-4">
          <div className="w-full sm:w-[90%] md:w-[70%] lg:w-[50%] xl:w-[40%] flex flex-col items-center rounded-4xl shadow-2xl p-6 md:p-8 border-2 border-[hsl(204,18%,80%)]
      bg-gradient-to-b from-[#F8F2EF] to-[#D3DADC]
      dark:from-[#1F1F1F] dark:to-[#2A2A2A]">
