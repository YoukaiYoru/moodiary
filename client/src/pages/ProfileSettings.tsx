...
import { Camera, Check, KeyRound, ShieldAlert, Trash2, UserRound } from "lucide-react";
...
export default function ProfileSettings() {
  ...
  if (loading) return <div className="mx-auto max-w-3xl py-12 text-center text-sm text-[#68777D]" role="status">Cargando tu perfil…</div>;

  return (
    <div className="mx-auto max-w-3xl space-y-5 pb-10">
      <header className="border-b border-[#D8E3E6] pb-4">
        <p className="mb-1 text-xs font-semibold uppercase tracking-[0.16em] text-[#68777D]">Cuenta</p>
        <h1 className="font-dosis text-2xl font-semibold text-[#455763]">Tu perfil y privacidad</h1>
        <p className="mt-1 text-sm text-[#68777D]">Personaliza tu espacio y decide qué conservar.</p>
      </header>
